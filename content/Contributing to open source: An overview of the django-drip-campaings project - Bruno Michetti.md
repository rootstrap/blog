## Contributing to open source: An overview of the django-drip-campaings project
...
As you can see, the queryset rules creation is very powerfull and for each drip you can add as many as you want.
